...
class Reconstruction():
    def __init__(self, voxel_resolution = 60, dct_resolution = 25) -> None:
    ...
    def fit_from_sdf(self, sdfs, voxel_resolution=60):
        self.voxel_resolution = voxel_resolution
        dct_trimmeds = []
        for sdf in sdfs:
            dct_full = dctn(sdf)
        ...
        self.gplvm.simple_gplvm(dct_flatteneds, 'vehicle_models', latent_dimension = 2, epsilon = 0.001, maxiter = 50)
